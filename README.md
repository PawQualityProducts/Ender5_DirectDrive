...
<table>
  ...
  <tr>
    ...
    <b>When extending Extruder drive Setpper Motor cable, be sure to connect correctly (ie. wire it as originally wired). You should NOT need to switch any wires. If your drive appears to be running in the wrong direction, then you have most-likely mounted the Extruder feed assembly incorrectly. The Extruder Feed assembly should be mounted upside down (ie. 180 degrees from it's original orientation) but should otherwise be assembled in exactly the same way it was before. </b>
  </p>
    </td>
